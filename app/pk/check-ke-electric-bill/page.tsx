...
const jsonLd = {'@context': 'https://schema.org', '@graph': [{'@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'K-Electric bill check online kaise karo?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'K-Electric bill check online ke liye apna 14-digit Reference Number enter karein aur submit press karein. Live duplicate bill ke liye official K-Electric portal use karein, kyun ke final billing data utility company ke server par hota hai.'}}, {'@type': 'Question', 'name': '14-digit K-Electric reference number kahan milta hai?', 'acceptedAnswer': {'@type': 'Answer', 'text': '14-digit reference number aap ke purane electricity bill ke top section mein hota hai. Ye Consumer ID ya CNIC se different ho sakta hai, is liye bill par printed Reference Number carefully copy karein.'}}, {'@type': 'Question', 'name': 'K-Electric bill kitne din mein update hota hai?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'K-Electric bill usually monthly billing cycle ke baad update hota hai. Agar naya bill show na ho to kuch time baad official portal dobara check karein.'}}, {'@type': 'Question', 'name': 'K-Electric duplicate bill download kaise karein?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reference Number enter karne ke baad official duplicate bill page par bill open hota hai. Wahan print ya download option browser ke print dialog se PDF ke form mein save kiya ja sakta hai.'}}, {'@type': 'Question', 'name': 'K-Electric bill payment last date kya hoti hai?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Payment last date har monthly bill par printed hoti hai. Late surcharge avoid karne ke liye due date se pehle bank, mobile wallet, ATM ya online banking se payment karein.'}}]}, {'@type': 'WebApplication', 'name': 'K-Electric Bill Checker', 'applicationCategory': 'UtilityApplication', 'operatingSystem': 'Web Browser', 'offers': {'@type': 'Offer', 'price': '0', 'priceCurrency': 'PKR'}, 'url': 'https://tools2do.com/pk/check-ke-electric-bill'}, {'@type': 'BreadcrumbList', 'itemListElement': [{'@type': 'ListItem', 'position': 1, 'name': 'Home', 'item': 'https://tools2do.com'}, {'@type': 'ListItem', 'position': 2, 'name': 'Pakistan Utilities', 'item': 'https://tools2do.com/pk'}, {'@type': 'ListItem', 'position': 3, 'name': 'K-Electric Bill Checker', 'item': 'https://tools2do.com/pk/check-ke-electric-bill'}]}]};
...
export default function Page(): React.ReactElement {
  return (
    <>
      <Script id="check-ke-electric-bill-schema" type="application/ld+json" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
